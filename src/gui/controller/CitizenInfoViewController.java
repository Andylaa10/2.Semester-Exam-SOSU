...
public class CitizenInfoViewController {
    ...
    public void setSelectedCitizen(Citizen citizen) throws Exception {
        ...
        lblGender.setText(citizen.getSex());
    ...
    private void newHCToVBox(int condition) throws SQLException {
        ...
        if (hcSubCategoryText.getCondition() != 0) {
            ...
            if (hcSubCategoryText.getExpectedLevelAssessment().equals("null")) {
                txtFieldExpectedLevel.setText("");
            } else {
            ...
            if (hcSubCategoryText.getCondition() == 1) {
                txtFieldCondition.setText("Potentiel");
                //txtFieldCondition.setStyle("-fx-background-color: yellow");
            } else if (hcSubCategoryText.getCondition() == 2) {
                txtFieldCondition.setText("Relevant");
                //txtFieldCondition.setStyle("-fx-background-color: light green");
            }
            ...
            if (hcSubCategoryText.getCondition() == 1) {
                txtFieldCondition.setText("Potentiel");
                vBoxNewHC.setBackground(new Background(new BackgroundFill(Color.rgb(238, 234, 126), CornerRadii.EMPTY, new Insets(0,0,15,0))));
            } else if (hcSubCategoryText.getCondition() == 2) {
                txtFieldCondition.setText("Relevant");
                vBoxNewHC.setBackground(new Background(new BackgroundFill(Color.LIGHTGREEN, CornerRadii.EMPTY, new Insets(0,0,15,0))));
            }
